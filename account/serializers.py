...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id','email','name','bio','profile_url','following','follower']
...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id','user','description','type','post_url','time_added','likes','time']

    def get_likes(self,obj):
        lll = obj.likes.all().count()
        return lll
    ...
    def get_time(self,obj):
        ...
        if round(time_diff/31536000) != 0 :
            ...
            ans = str(round(time_diff / 3600)) + ' hour ago'
...
class AddPostSerializer(serializers.ModelSerializer):
    class Meta:
        model = Post
        fields = ['id','description','type','post_url','time_added']
